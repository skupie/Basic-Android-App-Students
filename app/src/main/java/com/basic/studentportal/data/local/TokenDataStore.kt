...
class TokenDataStore @Inject constructor(
    ...
    companion object {
        ...
        // Stores the dueMonthCount that the user last dismissed.
        // -1 means "never dismissed" — always show on first encounter.
    ...
    /** Returns true if this exact dueMonthCount was already dismissed by the user. */
    ...
    /** Saves the count that was dismissed so it won't show again until the count changes. */
    ...
    /** Call on logout so the alert resets for the next session. */
